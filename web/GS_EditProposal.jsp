    ...
    <body>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" id="default" method="post" action="javascript:submitProposal()">
                                        <fieldset title="Description" class="step" id="default-step-0">
                                            <legend> </legend>
                                            <center><button class="btn btn-success" data-toggle="modal" value="Project Details" type="button" id="detailsB"><b>+</b> Show Comment</button></center>
                                            <br>
                                        ...
                                        <fieldset title="Materials" class="step" id="default-step-1" >
                                            <legend> </legend>
                                            <center><button class="btn btn-success" data-toggle="modal" value="Materials" type="button" id="materialsB"><b>+</b> Show Comment</button></center>
                                            <br>
                                        ...
                                        <fieldset title="Program" class="step" id="default-step-2" >
                                            <legend> </legend>
                                            <center><button class="btn btn-success" data-toggle="modal" value="Schedule" type="button" id="scheduleB"><b>+</b> Show Comment</button></center>
                                            <br>
                                            <div class="form-group">
                                        ...
                                        <fieldset title="Upload" class="step" id="default-step-4" >
                                            <legend> </legend>
                                            <center><button class="btn btn-success" data-toggle="modal" value="Testimonials" type="button" id="testimonialB"><b>+</b> Show Comment</button></center>
                                            <br>
                                        ...
                                        <input type="submit" id ="finishbutton" class="finish btn btn-success" value="Finish">
                                    </form>
                                </div>
                            </section>
                        </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#targetimplementationdate').val(st);
