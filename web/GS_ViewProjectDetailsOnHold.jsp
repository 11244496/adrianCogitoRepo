...
<%ArrayList<Task> tasks = p.getTask();
    ...
    boolean isEditable = (Boolean) session.getAttribute("isEditable");
%>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <% if (isEditable) {%>
                                <button type="button" id="submitModal" class="btn btn-info btn-sm" data-toggle="modal"><i class="fa fa-pencil"></i> Edit</button>
                                <%}%>
                            </span>
                        </header>
                    </section>
