                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                ...
                                <form id="processProj">
                                    ...
                                    <button type="button" id="setCompile" class="btn btn-success btn-sm">Set for compilation</button>
                                    <i style="margin-left: 5px;"></i>
                                    <button type="button" id="onHold" value ="onhold" class="btn btn-danger btn-sm">Put on hold</button>
                                    </center>
                                    <br>
                                </form>
                                <%}%>
                ...
                <section class="wrapper site-min-height">
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <span class="pull-right">
                                <button type="button" id="meetingDetails" class="btn btn-info btn-sm">View Meeting Details</button>
                            </span>
                        </header>
                    </section>
                                        ...
                                        <div class="col-lg-5" >
                                            <section class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <small>Current Status: <%out.print(p.getStatus());%></small></div>
                                            </section>
                                        </div>
                    ...
                    <div class="modal-content-wrap">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea rows="10" style="background: white; border:0px;" readonly class="wysihtml5 form-control" id="detailsTA" name="detailsTA">
                                    <%=p.getAnnotations().getDescription()%></textarea>
                                <textarea rows="10" style="background: white; border:0px;" readonly class="wysihtml5 form-control" id="materialsTA" name="materialsTA">
                                    <%=p.getAnnotations().getMaterials()%></textarea>
                                <textarea rows="10" style="background: white; border:0px;" readonly class="wysihtml5 form-control" id="scheduleTA" name="scheduleTA">
                                    <%=p.getAnnotations().getSchedule()%></textarea>
                                <textarea rows="10" style="background: white; border:0px;" readonly class="wysihtml5 form-control" id="testimonialTA" name="testimonialTA">
                                    <%=p.getAnnotations().getUpload()%></textarea>
