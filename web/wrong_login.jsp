        ...
        <div class="container"><br><br><br>
            <center><img src="img/final3_trans.png">
                ...
                <form class="form-signin" action="Login" method="GET"> 
                    ...
                    <p style="color:#E56B60; font-size: 13px;">Incorrect username/password. Please try again.</p>
                        ...
                        <div class="modal-content" style="width: 50%;">
                            ...
                            <form class="form-horizontal" id="default" action="Register">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">Password: <i class="required">*</i></label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">Confirm Password:  <i class="required">*</i></label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">First Name:  <i class="required">*</i></label>
                                        <input type="text" class="form-control regField" name="fn" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">Middle Name:  <i class="required">*</i></label>
                                        <input type="text" class="form-control regField" name="mn" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">Last Name:  <i class="required">*</i></label>
                                        <input type="text" class="form-control regField" name="ln" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label pull-left regFieldTitle">Address:  <i class="required">*</i></label>
