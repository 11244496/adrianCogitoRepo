                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" readonly style="background: white; border:0px;"  name="subject" value="<%=rList.get(x).getSender()%>">
                                    <br>
                                </div>
                                <label class="col-sm-2 col-sm-2 control-label">Date Sent: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" readonly style="background: white; border:0px;"  name="subject" value="<%=rList.get(x).getDateSent()%>">
                                    <br>
                                </div>
                                <label class="col-sm-2 col-sm-2 control-label">Message </label>
                                <div class="col-sm-10">
                                    <textarea class="wysihtml5 form-control" rows="7" name="content" readonly style="resize: none; background: white; border:0px; "><%=rList.get(x).getMessage()%></textarea>
                                </div>
