                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="bio-graph-heading project-heading">
                                    ...
                                    <span class="pull-right" style="margin-right: 3%">
                                        <br>
                                        <button class="btn btn-success" data-toggle="modal" type="button" value="Details" id="detailsB"><i class="fa fa-plus"></i> Add Comment</button>
                                        <br>
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <span class="pull-right" style="margin-right: 3%">
                                            <br>
                                            <button class="btn btn-success" data-toggle="modal" type="button" value="Pworks" id="pworksB"><i class="fa fa-plus"></i> Add Comment</button>
                                            <br>
                                        </span>
                            ...
                            <div class="row">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <span class="pull-right" style="margin-right: 3%">
                                            <br>
                                            <button class="btn btn-success" data-toggle="modal" type="button" value="Schedule" id="scheduleB"><i class="fa fa-plus"></i> Add Comment</button>
                                            <br>
                                        </span>
                            ...
                            <section class="panel">
                                ...
                                <span class="pull-right" style="margin-right: 3%">
                                    <br>
                                    <button class="btn btn-success" data-toggle="modal" type="button" value="Testimonial" id="testimonialB"><i class="fa fa-plus"></i> Add Comment</button>
                                    <br>
                                </span>
                    ...
                    <div class="modal-content-wrap">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea rows="10" style="background: white; border:0px;" class="wysihtml5 form-control" id="pworksTA" name="pworksTA"><%//=p.getAnnotations().getMaterials()%></textarea>
                                <textarea rows="10" style="background: white; border:0px;" class="wysihtml5 form-control" id="scheduleTA" name="scheduleTA"><%//=p.getAnnotations().getSchedule()%></textarea>
                                <textarea rows="10" style="background: white; border:0px;" class="wysihtml5 form-control" id="testimonialTA" name="testimonialTA"><%//=p.getAnnotations().getUpload()%></textarea>
                ...
                <div class="modal-dialog" >
                    <div class="modal-content" style="width: 50%;">
                        ...
                        <div class="modal-body form-group">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <textarea type="text" name="general"  class="form-control" rows="3" placeholder=""></textarea><br>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <textarea type="text" name="remarks"  class="form-control" rows="3" placeholder=""></textarea>
                                </div>
                            </div>
