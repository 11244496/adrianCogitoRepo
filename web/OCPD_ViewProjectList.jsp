<%-- 
    Document   : OCPD_ViewProjectList
    Created on : 03 16, 16, 5:57:06 PM
    Author     : RoAnn
--%>
                ...
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a  href="OCPD_ViewProjectList" class="active">&nbsp; &nbsp; &nbsp; &nbsp; View Project Proposals</a></li>
                                <li class="sub-menu">
        ...
        <script>
            function setBudget() {
                $.ajax({
                    ...
                    url: 'setbudget',
                    dataType: 'json',
                    data: {projid: $('#projId').val(), budget: $('#budget').val()},
                    cache: false,
                    success: function () {
                        alert("Budget successfully set for project");
