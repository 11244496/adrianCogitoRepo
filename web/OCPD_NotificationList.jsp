<%-- 
    Document   : OCPD_NotificationList
    Created on : 04 8, 16, 10:15:28 PM
    Author     : RoAnn
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li>
                        <a href="OCPD_NotificationList" class="active">
                            <i class="fa fa-book"></i>
        ...
        <section id="main-content">
            <%
                ArrayList<Notification> notificationlist = (ArrayList<Notification>) request.getAttribute("list");
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-hover p-table">
                                            ...
                                            <%                                                            for (int x = 0; x < notificationlist.size(); x++) {
                                                    String notif = notificationlist.get(x).getNotification();
                                                    String date = notificationlist.get(x).getDateTime();
