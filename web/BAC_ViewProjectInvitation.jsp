...
<%
    ...
    InvitationToBid invitation = (InvitationToBid) request.getAttribute("invitation");
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body bio-graph-info">
                                        ...
                                        <%
                                            ...
                                            d = invitation.getFolderName() + "/" + invitation.getFileName();

                                        %>


                                        <center>
                                            <iframe id="frameDoc" src ="<%=d%>" width="870" height="600"></iframe>
                                        </center>
