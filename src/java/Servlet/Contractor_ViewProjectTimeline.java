 ...
 * @author Krist
 */
@WebServlet(name = "Contractor_ViewProjectTimeline", urlPatterns = {"/Contractor_ViewProjectTimeline"})
public class Contractor_ViewProjectTimeline extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/Contractor_ProjectTimeline.jsp");
