 ...
 * @author AdrianKyle
 */
public class Contractor_ActivityandNotification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/Contractor_NotificationActivity.jsp");
