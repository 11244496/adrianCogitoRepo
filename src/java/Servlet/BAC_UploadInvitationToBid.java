                ...
                try {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            path = new File("C:\\Users\\AdrianKyle\\Documents\\NetBeansProjects\\Cogito\\Upload" + "/Bids and Awards Department" + "/Invitations to bid" + "/" + title + " invitation");
                            if (!path.exists()) {
                    ...
                    InvitationToBid invite = new InvitationToBid(0, fileName, null, project, "chrome-extension://affgigbpilagplecbaihihkcaddmlkji/" + "Bids and Awards Department" + "/Invitations to bid" + "/" + title + " invitation");
