 ...
 * @author Krist
 */
@WebServlet(name = "Contractor_Profile", urlPatterns = {"/Contractor_Profile"})
public class Contractor_Profile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ArrayList<Project> pList = contDAO.getProjectHistoryList("Implementation");
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/Contractor_Profile.jsp");
