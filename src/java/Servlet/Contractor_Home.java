 ...
 * @author Krist
 */
@WebServlet(name = "Contractor_Home", urlPatterns = {"/Contractor_Home"})
public class Contractor_Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/Contractor_Home.jsp");
