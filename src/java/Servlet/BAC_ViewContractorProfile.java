 ...
 * @author Krist
 */
@WebServlet(name = "BAC_ViewContractorProfile", urlPatterns = {"/BAC_ViewContractorProfile"})
public class BAC_ViewContractorProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/BAC_ContractorProfile.jsp");
