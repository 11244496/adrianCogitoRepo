 ...
 * @author Krist
 */
@WebServlet(name = "GS_ViewInspectionList", urlPatterns = {"/GS_ViewInspectionList"})
public class GS_ViewInspectionList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("listDate", listDate);
                ...
                RequestDispatcher dispatch = context.getRequestDispatcher("/GS_ViewInspectionList.jsp");
