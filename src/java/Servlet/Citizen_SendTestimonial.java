                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            if (!fileName.isEmpty()) {
                                ...
                                path = new File("C:\\Users\\AdrianKyle\\Desktop\\Final System Thesis 2\\FinalCogitoRepository\\Upload" + "/Citizen/" + title);
                                if (!path.exists()) {
...
//                        }
//                    }
                    Testimonial t = new Testimonial(title, null, message, "chrome-extension://cnjcgmljpkljlbhadlljlbhjkcbhlpcc/Citizen/", category, "Pending", c);
                    //Upload testimonial
