                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            if (!fileName.isEmpty()) {
                                ...
                                path = new File("D:\\Development\\NetBeans\\Projects\\Cogito\\Cogito\\Upload" + "/Citizen/" + title);
                                if (!path.exists()) {
...
//                        }
//                    }
                    Testimonial t = new Testimonial(title, null, message, "chrome-extension://jeffkcnncmegidbibehpfbklfeebhfhj/Citizen/", category, "Unlinked", c);
                    //Upload testimonial
