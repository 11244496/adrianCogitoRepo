                ...
                try {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            File path = new File("C:\\Users\\AdrianKyle\\Desktop\\Final System Thesis 2\\FinalCogitoRepository\\Upload" + "/Engineering Department" + "/planningdocuments_TEMP");
                            if (!path.exists()) {
                    ...
                    d.setName(fileName);
                    d.setUrl("chrome-extension://cnjcgmljpkljlbhadlljlbhjkcbhlpcc/Engineering Department/planningdocuments_TEMP/" + fileName);
                    d.setType(type);
                    d.setEmployee(e);
