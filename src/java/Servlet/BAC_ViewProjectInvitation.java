 ...
 * @author Krist
 */
@WebServlet(name = "BAC_ViewProjectInvitation", urlPatterns = {"/BAC_ViewProjectInvitation"})
public class BAC_ViewProjectInvitation extends HttpServlet {
...
//References
            ...
            RequestDispatcher dispatch = context.getRequestDispatcher("/BAC_ViewProjectInvitation.jsp");
